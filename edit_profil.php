...
if (isset($_POST['submit'])) {
    ...
    if ($valid == TRUE) {
        ...
        $query = "UPDATE user SET nama='$nama_akun',username='$keterangan',password='$password' WHERE id='$id'";
        $result = $db->query($query);
        ...
        if (!$result) {
            ...
            echo "<script>
              ...
              var yakin = confirm('Data Anda akan di edit di tabel user');
              if (yakin) {
        ...
        echo "<script>alert('Maaf belum berhasil');window.location='profil.php'</script>";
    }
};
