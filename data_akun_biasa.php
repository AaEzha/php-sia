...
<div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                <div class="col-sm">
            <a type="button" class="btn btn-warning rounded shadow-sm" href="tambah_data_akunB.php">Tambah Akun</a>
                    ...
                    <?php
                      ...
                      if(!$result){
                        ...
                        while ($row = $result->fetch_object()) {
                          ...
                          echo '<td>   <a class="btn btn-primary shadow rounded" href="edit_data_akun_biasa.php?&id='.$row->id.'" role="button">Edit</a>
                                      <a class="btn btn-danger shadow rounded" href="hapus_data_akun_biasa.php?no_reff='.$row->no_reff.'&id='.$row->id.'" role="button">Hapus</a></td>';
