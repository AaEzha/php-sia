...
<div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card-header">
              ...
              <form action=" " method="POST">
                  ...
                  <a type="button" class="btn btn-warning rounded shadow-sm" href="data_akun.php">Kembali</a>
                </form>
                </div>
              </div>
            </div>
      ...
      <?php 
        ...
        if($valid==TRUE) {
          ...
          $sem = $i+1;
          $query = "INSERT INTO tb_akun (no_reff,nama_akun,keterangan,id) VALUES ('$no_reff','$nama_akun','$keterangan','$sem')";
          $result = $db->query($query);
            if (!$result) {
              die('Could not query the database: <br>'.$db->error.'<br>Query: '.$query);
            } else {
              echo "<script>alert('Data Akun sudah ditambahkan');window.location='data_akun.php'</script>";
            
              }
        }else{
          echo "<script>alert('Maaf belum berhasil');window.location='tambah_data_akun.php'</script>";
        }
      };
