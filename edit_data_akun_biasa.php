                    ...
                    ?>
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" rows="4" id="keterangan" name="keterangan" required><?php echo $row->keterangan ?></textarea>
...
if (isset($_POST['submit'])) {
    ...
    if ($valid == TRUE) {
        ...
        $query = "UPDATE tb_akun SET no_reff ='$no_reff',nama_reff='$nama_akun',keterangan='$keterangan' WHERE id='$id'";
        $result = $db->query($query);
        ...
        if (!$result) {
            ...
            echo "<script>
              ...
              var yakin = confirm('Data Anda akan di edit di jurnal?');
              if (yakin) {
        ...
        echo "<script>alert('Maaf belum berhasil');window.location='data_akun_biasa.php'</script>";
    }
};
