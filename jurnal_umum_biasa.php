...
<div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-5">
                <a type="button" class="btn btn-primary shadow rounded" href="tambah_akunTo_jurna_biasa.php">Tambah Akun ke Jurnal</a>
                </div>
                <div class="col-sm">
                <!--
              ...
              <div class="card-body">
                ...
                if(!$result){
                  ...
                  while ($row = $result->fetch_object()) {
                    ...
                    echo '<td>  <a class="btn btn-md btn-warning shadow rounded" href="tampil_jurnal_biasa.php?bulan='.$row->bulan.'&tahun='.$row->tahun.'" role="button">Tampil</a>
                              </td>';
