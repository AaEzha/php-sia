...
?>
<?php include 'include/header_jurnal.php'; ?>
...
<div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                <div class="col-sm">
            <a rulo="button" class="btn btn-md btn-primary rounded shadow" href="tambah_akunTo_jurna.php">Tambah Data Akun ke Jurnal</a>
            <a class="btn btn-md btn-danger shadow rounded" href="jurnal_umum.php" role="button">Kembali</a>
                </div> 
                </div>  
                      ...
                      if(!$result){
                        ...
                        while ($row = $result->fetch_object()) {
                         ...
                         $jumlah2= $row->kredit_jurnal + $jumlah2;
                          ...
                          echo '<td class="text-right">  <a class="btn btn-sm btn-secondary shadow rounded" href="edit_data_jurnal.php?id='.$row->id.'&no_reff='.$row->no_reff.'" role="button">Edit</a>
                                    <a class="btn btn-sm btn-danger shadow rounded" href="hapus_data_jurnal.php?no_reff='.$row->no_reff.'&tgl='.$row->tgl.'&id='.$row->id.'&jenis='.$row->jenis.'" role="button">Hapus</a></td>';
                                    $i++;
